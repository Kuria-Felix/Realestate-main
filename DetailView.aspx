<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailView.aspx.cs" Inherits="Onyango_estates.DetailView" %>
...
<body>
    ...
    <asp:DataList ID="DataList1" runat="server" BorderColor="#DEBA84"
        ...
        DataSourceID="SqlDataSource1" GridLines="Both" RepeatColumns="5" OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
