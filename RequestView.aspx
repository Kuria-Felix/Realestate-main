<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestView.aspx.cs" Inherits="Onyango_estates.RequestView" %>
    ...
    <form id="form1" runat="server">
        ...
        <tr>
            <td style="width: 100px; height: 17px;">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Request.aspx" Width="79px">Add 
                Request</asp:HyperLink></td>
        </tr>
        <tr>
            <td align="center" height="300" valign="top">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    CellPadding="4" DataKeyNames="Tran_Id" DataSourceID="SqlDataSource1" ForeColor="#333333"
                    GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Budget" SortExpression="Estimate_Budget">
                            ...
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlBudget" runat="server" Enabled="False" SelectedValue='<%# Bind("Estimate_Budget") %>' EnableTheming="True">
                                    <asp:ListItem Value="0" Selected="True">--Select(In Lac)--</asp:ListItem>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\RealEstate.mdf;Integrated Security=True;User Instance=True"
                    ...
                    <SelectParameters>
                        <asp:SessionParameter Name="Member_Id" SessionField="MemId" Type="Int32" />
                    </SelectParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Tran_Date" Type="DateTime" />
                        <asp:Parameter Name="Member_Id" Type="Int32" />
