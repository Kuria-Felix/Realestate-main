<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstateDetail.aspx.cs" Inherits="Onyango_estates.EstateDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <tr>
            <td>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="Member_Id" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" GridLines="Both" style="margin-right: 70px">
        <ItemTemplate>
